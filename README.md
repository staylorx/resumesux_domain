...
A clean architecture Dart package for resume and job application generation using AI. This package provides the domain and data layers for the Resume Suckage application, including entities, use cases, and data repositories with AI service integration. Supports multiple AI providers like LM Studio.
